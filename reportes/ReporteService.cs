...
namespace desagotes.reportes
{
    ...
    { 
        ...
        public String crearPdf()
        {
            ...
            mNombreDocumentoCompleto = Utils.ObtenerPathDOCS() +"OrdenNro" + NroOrden + ".pdf";
            mNombreDocumento = "OrdenNro" + NroOrden + ".pdf";
            ...
            vTablaTitulo.AddCell(UtilsPdf.getParrafo("ORDEN DE REPARACION", FontFactory.GetFont(FontFactory.HELVETICA, 17, Font.BOLDITALIC)));
            ...
            vTablaTituloReporte.AddCell(UtilsPdf.getParrafo("DATOS DE LA REPARACION", FontFactory.GetFont(FontFactory.HELVETICA, 11, Font.BOLD)));
