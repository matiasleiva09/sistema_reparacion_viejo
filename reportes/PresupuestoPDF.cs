...
namespace reparaciones2.reportes
{
    class PresupuestoPDF
    {
        ...
        private IList<ItemPresupuesto> mDatos = new List<ItemPresupuesto>();
        ...
        public IList<ItemPresupuesto> Datos
        {
            get { return mDatos; }
            set { mDatos = value; }
        }
        ...
        public String crearPdf()
        {
            ...
            mNombreDocumento = "PS" + mNroRecibo + ".pdf";
            mNombreDocumentoCompleto = Utils.ObtenerPathDOCS() + "PS" + mNroRecibo + ".pdf";
            ...
            vTablaTitulo.AddCell(UtilsPdf.getParrafo("PRESUPUESTO DE INSUMOS", FontFactory.GetFont(FontFactory.HELVETICA, 17, Font.BOLDITALIC)));
            ...
            //----------------------------------------------------------------------------------------
            //TITULO-----------------------------------------------------------
            float[] vAnchoFecha = { UtilsPdf.convertirCm(3f), UtilsPdf.convertirCm(3f) };
            PdfPTable vTablaFecha = new PdfPTable(vAnchoFecha);
            vTablaFecha.DefaultCell.Padding = 0.0f;
            vTablaFecha.TotalWidth = UtilsPdf.convertirCm(6.0f);
            ...
            vTablaTituloReporte.AddCell(UtilsPdf.getParrafo("DATOS DEL PRESUPUESTO", FontFactory.GetFont(FontFactory.HELVETICA, 11, Font.BOLD)));
            ...
            vTablaDetalleP.AddCell(UtilsPdf.getParrafo("DETALLE DEL PRESUPUESTO", FontFactory.GetFont(FontFactory.HELVETICA, 11, Font.BOLD)));
            ...
            vDetalle.AddCell(UtilsPdf.getParrafo("Cant.", UtilsPdf.getFontMedianoBlanco()));
