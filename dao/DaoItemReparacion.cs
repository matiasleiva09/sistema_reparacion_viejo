...
{
    public static class DaoItemReparacion
    {
        public static void Guardar(ItemInsumoTarifa xItem)
        {
            string vSQL = "";
            vSQL = "insert into item_reparacion ";
            vSQL += "(idreparacion,idtarifa,idinsumo,cantidad,neto,iva,monto)";
            vSQL += " values (";
            vSQL += xItem.Reparacion.Id + ",";
        ...
        public static long ObtenerId(ItemInsumoTarifa xItem)
        {
            long vRes = 0;
            string vSQL = "";
            vSQL += "select id from item_reparacion where ";
            ...
            vSQL += " idreparacion=" + xItem.Reparacion.Id + " and";
        ...
        {
            string vSQL = "";
            vSQL = "update item_reparacion";
            vSQL += " set";
            vSQL += " idtarifa=" + xItem.IdTarifaParaBase() + ",";
            vSQL += " idinsumo=" + xItem.IdArticuloParaBase() + ",";
            vSQL +=  "idreparacion=" + xItem.Reparacion.Id + ",";
            vSQL += " idrecibo=" + xItem.IdReciboParaBase() + ",";
        ...
        {
            string vSQL = "";
            vSQL = "delete from item_reparacion";
        ...
        public static DataTable ObtenerItemDeReparacion(long xIdReparacion)
        {
           ...
           // vSQL += " idrecibo as \"Recibo\",";
            ...
            vSQL += " where ir.idreparacion=" + xIdReparacion;
        ...
        public static DataTable ObtenerTarifaInsumo()
        {
            ...
            vSQL += " round(monto,2) as monto,'TARIFA' as tipo ";
            vSQL += " from tarifa where servicio = 'REPARACION'";
            vSQL += " union";
